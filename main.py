...
class CafeForm(FlaskForm):
    ...
    Location_URL = StringField('Cafe Location name (URL)', validators=[DataRequired(), URL(message='Invalid URL')])
    opening = StringField('Opening time eg.9 A.M.', validators=[DataRequired()])
    closing = StringField('Closing time 10 P.M.', validators=[DataRequired()])
